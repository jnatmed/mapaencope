...
export class BuenosAiresComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.tallerescpf1 = [
      ...
      { nombre_de_taller: 'Mantenimiento Gral del Establecimiento', cantidad_de_internos_trabajadores: 53 + 46 },
    ...
    this.tallerescpf2 = [
      ...
      { nombre_de_taller: 'Mantenimiento Gral del Establecimiento', cantidad_de_internos_trabajadores: 109 + 276 },
    ...
    this.tallerescpf4 = [
      ...
      { nombre_de_taller: 'Mantenimiento Gral del Establecimiento', cantidad_de_internos_trabajadores: 63 + 116},
    ...
    this.talleresu19 = [
      ...
      { nombre_de_taller: 'Mantenimiento Gral del Establecimiento', cantidad_de_internos_trabajadores: 36 + 3},
    ...
    this.tallerescfja = [
      ...
      { nombre_de_taller: 'Mayordomía', cantidad_de_internos_trabajadores: 17 },
      { nombre_de_taller: 'Mantenimiento Gral del Establecimiento', cantidad_de_internos_trabajadores: 7 + 3},
    ...
    this.tallerescpfcaba = [
      ...
      { nombre_de_taller: 'Mayordomía', cantidad_de_internos_trabajadores: 11 },
      { nombre_de_taller: 'Mantenimiento Gral del Establecimiento', cantidad_de_internos_trabajadores: 6 + 30 },
    ...
    this.tallerescpfvii = [
      ...
      { nombre_de_taller: 'Mantenimiento Gral del Establecimiento', cantidad_de_internos_trabajadores: 6 + 48 },
      { nombre_de_taller: 'Lavadero de Ropa', cantidad_de_internos_trabajadores: 3 },
